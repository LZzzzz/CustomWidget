...
public class StatusBarUtil {
    ...
    public static final float DEFAULT_STATUS_BAR_ELEVATION = 0.0f;
    ...
    public static void setColorForDrawerLayout(Activity activity, DrawerLayout drawerLayout, @ColorInt int color) {
        setColorForDrawerLayout(activity, drawerLayout, color, DEFAULT_STATUS_BAR_ALPHA, DEFAULT_STATUS_BAR_ELEVATION);
    }
    ...
    public static void setColorNoTranslucentForDrawerLayout(Activity activity, DrawerLayout drawerLayout, @ColorInt int color) {
        setColorForDrawerLayout(activity, drawerLayout, color, 0, DEFAULT_STATUS_BAR_ELEVATION);
    }
     ...
     */
    public static void setColorForDrawerLayout(Activity activity, DrawerLayout drawerLayout, @ColorInt int color,
                                               @IntRange(from = 0, to = 255) int statusBarAlpha, float elevation) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        ...
        if (fakeStatusBarView != null) {
            ...
            fakeStatusBarView.setBackgroundColor(color);
            fakeStatusBarView.setElevation(elevation);
        } else {
            View barView = createStatusBarView(activity, color);
            barView.setElevation(elevation);
            contentLayout.addView(barView, 0);
        }
